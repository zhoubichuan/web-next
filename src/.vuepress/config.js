...
module.exports = {
  title: 'next学习笔记',
  description: 'next相关知识点',
  base: '/web-next/', // 部署站点的基础路径
  port: 3010,
  dest: 'web-next', // 指定 vuepress 的输出目录
  markdown: {
  ...
  // 主题配置
  themeConfig: {
    repo: 'https://github.com/zhoubichuan/web-next', // 源码地址
